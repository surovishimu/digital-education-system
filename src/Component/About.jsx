...
const About = () => {
    return (
        <div id="about" className="flex flex-col  md:flex-col lg:flex-row-reverse justify-between items-center px-10 gap-24 mt-20">
            <div className="flex-1">
                ...
                <div>
                    <div className="flex justify-around items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-xl font-semibold mb-3">Flexible Classes</h1>
                    ...
                    <div className="flex justify-around items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-xl font-semibold mb-3">Learn From Anywhere</h1>
                            <p className="w-2/3 mb-4">
